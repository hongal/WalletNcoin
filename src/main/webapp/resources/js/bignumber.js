;(function (globalObject) {
    ...
    function clone(configObject) {
         ...
         * BigNumber(y, b).
         */
        P.minus = P.subtract = P.sub = P.gap = function (y, b) {
            var i, j, t, xLTy,
                x = this,
                a = x.s;
         ...
         */
        P.modulo = P.mod = P.remainder = function (y, b) {
            var q, s,
                x = this;
         ...
         * of BigNumber(y, b).
         */
        P.multipliedBy = P.times = P.multiply = P.mul = function (y, b) {
         ...
         * BigNumber(y, b).
         */
        P.plus = P.add = P.sum = function (y, b) {
            var t,
                x = this,
                a = x.s;
